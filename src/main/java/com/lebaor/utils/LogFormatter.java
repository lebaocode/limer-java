...
public class LogFormatter extends Formatter {
    ...
    /**
     * Install this LogFormatter to the root Logger.
     * @see LogFormatter#install(LogFormatter, String)
     */
    public static void install() {
        install("");
    }
    /**
     * Install this formatter (or a subclass of it) to the root Logger.
     * @see LogFormatter#install(LogFormatter, String)
     * @param formatter
     */
    public static void install(LogFormatter formatter) {
        install(formatter, "");
    }
    /**
     * Install LogFormatter to the Logger with the given name.
     * @see LogFormatter#install(LogFormatter, String)
     * @param name
     */
    public static void install(String name) {
        install(new LogFormatter(), name);
    }
    /**
     * Install this formatter (or a subclass of it) to the Logger with the given name.
     * This will override all previously set Formatters. If no handler has been
     * added to this Logger, a ConsoleHandler will be added.
     * @param formatter 
     * @param name
     */
    public static void install(LogFormatter formatter, String name) {
        Logger logger = LogFormatter.getLogger(name);
